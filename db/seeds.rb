seed_data = {
  'Ween' => {
    'The Mollusk' => ["I'm Dancing In The Show Tonight", "The Mollusk", "Polka Dot Tail", "I'll Be Your Jonny On The Spot", "Mutilated Lips", "The Blarney Stone", "It's Gonna Be (Alright)", "The Golden Eel", "Cold Blows the Wind", "Pink Eye (On My Leg)", "Waving My **** In The Wind", "Buckingham Green", "Ocean Man", "She Wanted to Leave / (Reprise)"],
...
seed_data.each do |artist, albums|
